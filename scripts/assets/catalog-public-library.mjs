...
for (const receipt of receipts) {
  ...
  packs.push({
    ...
    licenseUrl: receipt.licenseUrl ?? 'https://creativecommons.org/publicdomain/zero/1.0/',
    creator: receipt.creator ?? 'Kenney',
...
const manifest = {
  ...
  acquired: acquisitionDate,
  licensePolicy: 'Packs with verified license records (CC0-1.0, OFL-1.1, CC-BY-3.0) from official source pages',
  packs,
  files,
}
