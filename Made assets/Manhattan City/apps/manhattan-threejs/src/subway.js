// subway.js — 658 station entrances, and the footfall they generate.
//
...
// instances and 698 triangles between two meshes this needs no streaming —
...
export class Subway {
  ...
  async load(dataUrl = '/subway/subway.json',
    footUrl = '/subway/footfall.json', glbUrl = '/tiles/subway.glb') {
